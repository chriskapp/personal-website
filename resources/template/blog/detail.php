  ...
  <div class="col-md-12">
    <div class="card border-0" itemscope itemtype="https://schema.org/BlogPosting">
      <div class="card-body">
        ...
        <div class="mt-3"><?php foreach(explode(',', $entry->category) as $category): ?><span class="badge rounded-pill text-bg-primary me-1"><?php echo $category; ?></span><?php endforeach; ?></div>
      </div>
    </div>
  </div>
</div>
