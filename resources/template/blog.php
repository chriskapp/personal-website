...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card border-0" itemscope itemtype="https://schema.org/BlogPosting">
      <div class="card-body">
        <h1 class="card-title fw-bold fs-4 text-start" itemprop="name"><a href="<?php echo $router->getUrl([\App\Controller\Blog\Detail::class, 'show'], ['title' => $row->title_slug]); ?>"><?php echo $row->title; ?></a></h1>
